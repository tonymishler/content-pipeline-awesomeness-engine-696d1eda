...
const ComplianceResult: React.FC<Props> = ({ foundIssues, result, onReset, selectedIssueIdx }) => {
  ...
  return (
    <div className="animate-fade-in flex flex-col gap-4">
      <div className="bg-blue-50 border-l-4 border-blue-500 rounded px-4 py-2 text-sm mb-2">
        <b className="text-blue-500">Compliance Check Complete.</b>
        <br />
      ...
      <div
        ref={containerRef}
        className="whitespace-pre-wrap text-lg bg-white rounded shadow-inner p-4 font-mono leading-relaxed max-h-[420px] overflow-y-auto border border-blue-500 scroll-smooth"
      >
